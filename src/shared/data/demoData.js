...
export const DEMO_ACHIEVEMENTS = [
  {
    ...
    studentId: 'student-1',
    activityId: 'act-1',
    title: 'Победитель школьного хакатона по робототехнике',
    description: '1-е место в командном зачёте по сборке и программированию автономного робота',
    badgeIcon: 'trophy',
    issuedBy: 'teacher-1',
  ...
  },
  {
    ...
    studentId: 'student-1',
    activityId: 'act-1',
    title: '100% посещаемость секции Arduino',
    description: 'Безупречная посещаемость всех практических и теоретических занятий',
    badgeIcon: 'award',
    issuedBy: 'teacher-1',
  ...
  },
  {
    ...
    studentId: 'student-1',
    activityId: 'act-1',
    title: 'Сертификат за лучший проект IoT',
    description: 'Разработка прототипа умной метеостанции для школьного кабинета',
    badgeIcon: 'star',
    issuedBy: 'teacher-1',
  ...
  },
  {
    ...
    studentId: 'student-2',
    activityId: 'act-2',
    title: 'Гран-при театрального фестиваля «Маска»',
    description: 'Главная женская роль в постановке классической школьной драмы',
    badgeIcon: 'trophy',
    issuedBy: 'teacher-2',
  ...
  },
  {
    ...
    studentId: 'student-2',
    activityId: 'act-2',
    title: 'Лучшая декламация классической поэзии',
    description: 'Победа на конкурсе сценической речи',
    badgeIcon: 'star',
    issuedBy: 'teacher-2',
  ...
  },
  {
    ...
    studentId: 'student-3',
    activityId: 'act-3',
    title: '1-е место в турнире по быстрым шахматам',
    description: 'Победа во всех 7 турах школьного рапид-турнира',
    badgeIcon: 'trophy',
    issuedBy: 'teacher-3',
  ...
  },
  {
    ...
    studentId: 'student-3',
    activityId: 'act-3',
    title: 'Тактический гроссмейстер школы',
    description: 'Решение сложнейших этюдов на тактику и эндшпиль',
    badgeIcon: 'award',
    issuedBy: 'teacher-3',
  ...
  },
  {
    ...
    studentId: 'student-4',
    activityId: 'act-4',
    title: 'Золотая медаль школьного первенства по волейболу',
    description: 'Лидерство в финальной серии игр среди параллели 7-х классов',
    badgeIcon: 'trophy',
    issuedBy: 'teacher-4',
  ...
  },
  {
    ...
    studentId: 'student-4',
    activityId: 'act-4',
    title: 'Капитан спортивной команды четверти',
    description: 'Отличные лидерские качества и поддержка товарищей по команде',
    badgeIcon: 'star',
    issuedBy: 'teacher-4',
  ...
  },
  {
    ...
    studentId: 'student-5',
    activityId: 'act-6',
    title: 'Диплом I степени на олимпиаде по математике',
    description: 'Высший балл среди участников олимпиадного резерва школы',
    badgeIcon: 'trophy',
    issuedBy: 'teacher-6',
  ...
  },
  {
    ...
    studentId: 'student-5',
    activityId: 'act-6',
    title: 'Успешное решение задач повышенной сложности',
    description: 'Решение комплексных геометрических теорем на занятиях',
    badgeIcon: 'award',
    issuedBy: 'teacher-6',
  ...
  },
  {
    ...
    studentId: 'student-6',
    activityId: 'act-8',
    title: 'Лучший бомбардир школьной футбольной лиги',
    description: 'Забито 8 мячей за стартовую серию матчей осеннего сезона',
    badgeIcon: 'trophy',
    issuedBy: 'teacher-8',
  ...
  },
  {
    ...
    studentId: 'student-7',
    activityId: 'act-9',
    title: 'Победитель осенней выставки живописи',
    description: 'Приз зрительских симпатий за пейзажную серию «Краски осени»',
    badgeIcon: 'star',
    issuedBy: 'teacher-9',
  ...
  },
  {
    ...
    studentId: 'student-8',
    activityId: 'act-5',
    title: 'Победитель дебатного турнира на английском',
    description: 'Лучший спикер в секции школьных дебатов на иностранном языке',
    badgeIcon: 'award',
    issuedBy: 'teacher-5',
