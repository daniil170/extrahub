...
export function AboutPage() {
  ...
  const roles = [
    {
      id: 'role-student',
      title: 'Ученик',
      teaser: 'Каталог секций, бронь с 24-часовым таймером и расписание.',
      icon: GraduationCap,
      details: [
        ...
        'Удобное отслеживание статуса записи, расписания и истории посещений.',
      ],
      tags: ['КАТАЛОГ СЕКЦИЙ', 'ХОЛД 24 ЧАСА', 'РАСПИСАНИЕ'],
    },
    {
      id: 'role-parent',
      title: 'Родитель',
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      teaser: 'Идея хаба, CustDev-исследование школ и проектирование CJM.',
      icon: Lightbulb,
      details: [
        ...
        'Спроектировал сценарии взаимодействия учеников со школьными секциями и расписанием.',
      ],
      tags: ['PRODUCT CONCEPT', 'CUSTDEV', 'CJM DESIGN'],
    },
    {
      id: 'team-maulen',
